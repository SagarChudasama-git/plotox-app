...
(function () {
  ...
  // Bind loader reveal to page initialization, handling cases where 'load' event already fired
  if (document.readyState === 'complete') {
    startLoaderReveal();
  } else {
    window.addEventListener('load', startLoaderReveal);
  }
})();
